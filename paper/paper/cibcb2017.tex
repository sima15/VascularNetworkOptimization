...
\title{Vascular Network Optimization Using Genetic Algorithm: A Computational Study\\}
%
%
...
\author{Sima Mehri, Curtis Larsen, Nicholas~S.~Flann % <-this % stops a space
\IEEEcompsocitemizethanks{Sima Mehri, Curtis Larsen, and ~Nicholas~S.~Flann  are with Utah State University, Logan, Utah,  USA.
e-mail: (sima.mehri.k@aggiemail.usu.edu, Larsen@dixie.edu , and nick.flann@usu.edu)}}% <-this % stops a space
...
\input{method_METHOD.tex}



\section{RESULTS}

\input{method_RESULTS.tex}
